...
namespace Gods_Of_Pharloom
{
    public class BossInfo
    {
        ...
        public static void InitBossesInfo()
        {
            ...
            {
                new BossInfo("Tut_03", "start_battle_entry", "Moss Mother", new string[]{"Mossbone Mother"},new float[][]{new float[]{2f, 3f}}, 
                        ascendedVersion : new BossInfo("Weave_03", "start_battle_entry", "Moss Mother", new string[]{"Mossbone Mother A", "Mossbone Mother B"}, new float[][]{new float[]{2f, 3f}, new float[]{2f, 2f}})),
                new BossInfo("Bone_05", "start_battle_entry", "Bell Beast", new string[]{"Bone Beast"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Bone_East_08", "start_battle_entry", "Fourth Chorus", new string[]{"song_golem"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Coral_11", "start_battle_entry", "Great Conchflies", new string[]{"Driller A", "Driller B"}, new float[][]{new float[]{2f, 3f}, new float[]{2f, 3f}}),
                ...
                new BossInfo("Ant_19", "start_battle_entry", "Savage Beastfly in Chapel of The Beast", new string[]{"Bone Flyer Giant"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Shellwood_18", "start_battle_entry", "Sister Splinter", new string[]{"Splinter Queen"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Bone_15", "start_battle_entry", "Skull Tyrant", new string[]{"Skull King"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Belltown_Shrine", "start_battle_entry", "Widow", new string[]{"Spinner Boss"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Slab_16b", "start_battle_entry", "Broodmother", new string[]{"Slab Fly Broodmother"}, new float[][]{new float[]{2f, 3f}}),
                new BossInfo("Cog_Dancers", "start_battle_entry", "Cogwork Dancers", new string[]{"Dancer A", "Dancer B"}, new float[][]{new float[]{2f, 3f}, new float[]{2f, 3f}}),
                new BossInfo("Dust_Chef", "start_battle_entry", "Disgraced Chef Lugoli", new string[]{"Roachkeeper Chef (1)"}, new float[][]{new float[]{2f, 3f}}),
                ...
                new BossInfo("Dock_09", "start_battle_entry", "Forebrothers Signis & Gron", new string[]{"Dock Guard Slasher", "Dock Guard Thrower"}, new float[][]{new float[]{2f, 3f}, new float[]{2f, 3f}}),
                ...
                new BossInfo("Coral_27", "start_battle_entry", "Raging Conchfly", new string[]{"Coral Conch Driller Giant Solo"}, new float[][]{new float[]{2f, 3f}}),
                ...
                new BossInfo("Room_CrowCourt_02", "start_battle_entry", "Crawfather", new string[]{"Crawfather"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
                new BossInfo("Memory_Coral_Tower", "start_battle_entry", "Crust King Khann", new string[]{"Coral King"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
                new BossInfo("Bone_East_18b", "start_battle_entry", "Gurr the Outcast", new string[]{"Bone Hunter Trapper"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
                ...
                new BossInfo("Shellwood_11b_Memory", "start_battle_entry", "Nyleth", new string[]{"Flower Queen Boss"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
                ...
                new BossInfo("Shellwood_22", "start_battle_entry", "Shrine Guardian Seth", new string[]{"Seth"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
                new BossInfo("Memory_Ant_Queen", "start_battle_entry", "Skarrsinger Karmelita", new string[]{"Hunter Queen Boss"}, new float[][]{new float[]{2f, 3f}}, is3ActBoss: true),
